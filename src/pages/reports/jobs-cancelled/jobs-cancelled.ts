...
@IonicPage()
@Component({
  selector: 'page-jobs-cancelled',
  templateUrl: 'jobs-cancelled.html',
})
export class JobsCancelledPage extends AbstractPage{
