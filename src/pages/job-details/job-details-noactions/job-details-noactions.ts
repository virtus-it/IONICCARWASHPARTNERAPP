...
@IonicPage()
@Component({
  selector: 'page-job-details-noactions',
  templateUrl: 'job-details-noactions.html',
})
export class JobDetailsNoactionsPage {
  ...
  constructor(private modalCtrl: ModalController,
    ...
    this.alertUtils.showLog('JobDetailsNoactionsPage');
